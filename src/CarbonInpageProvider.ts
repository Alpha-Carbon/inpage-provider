...
export interface CarbonInpageProviderOptions extends BaseProviderOptions {
  /**
...
export default class CarbonInpageProvider extends BaseProvider {
   ...
   */
  public readonly _carbon: ReturnType<
    CarbonInpageProvider['_getExperimentalApi']
  >;

  public networkVersion: string | null;

  /**
   * Indicating that this provider is a Carbon provider.
   */
  public readonly isCarbon: true;

  /**
   * @param connectionStream - A Node.js duplex stream
   * @param options - An options bag
   * @param options.jsonRpcStreamName - The name of the internal JSON-RPC stream.
   * Default: carbon-provider
  ...
  constructor(
    ...
    this._carbon = this._getExperimentalApi();
   ...
   * @emits CarbonInpageProvider#disconnect
   */
  ...
  /**
   * Constructor helper.
   * Gets experimental _carbon API as Proxy, so that we can warn consumers
  ...
  protected _getExperimentalApi() {
    return new Proxy(
      {
        /**
         * Determines if Carbon is unlocked by the user.
         *
         * @returns Promise resolving to true if Carbon is currently unlocked
         */
        isUnlocked: async () => {
   ...
   *
   * @emits CarbonInpageProvider#chainChanged
   * @emits CarbonInpageProvider#networkChanged
